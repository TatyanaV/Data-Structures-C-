...
* References:
*   1. Lecture on Heap Implementation - some functions taken from the lectture
*   2. Worksheet 33 -- a lot of fuctions taken directly from the worksheet
*   3. https://github.com/baylesj/cs261/blob/master/5/turn-in/dynamicArray.c
*   4. Piazza discussion boad----Xinchen Wang and Christopher Kryaninko
*
* ============================================================================
*/
#include <assert.h>
